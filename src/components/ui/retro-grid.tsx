            ...
            <div className="absolute inset-0 [transform:rotateX(35deg)]">
                <div
                    className={cn(
                        ...
                        // Custom UCSB Future Style
                        "[background-image:linear-gradient(to_right,rgba(254,188,17,0.2)_1px,transparent_0),linear-gradient(to_bottom,rgba(56,189,248,0.2)_1px,transparent_0)]"
                    )}
                />
            </div>
