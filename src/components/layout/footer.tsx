                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-4">
                            ...
                            <li>
                                <Link href="/students" className="text-base text-slate-400 hover:text-ucsb-gold">
                                    Students
                                </Link>
                            </li>
                            <li>
                                <Link href="/product" className="text-base text-slate-500 hover:text-navy">
                                    Product
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-4">
                            <li>
                                <Link href="/team" className="text-base text-slate-400 hover:text-ucsb-gold">
                                    Team
                                </Link>
                            </li>
                            <li>
                                <a href={`mailto:${CONTENT.common.links.contactEmail}`} className="text-base text-slate-400 hover:text-ucsb-gold">
                                    Contact
                                </a>
                            </li>
                            <li>
                                <a href={CONTENT.common.links.github} target="_blank" rel="noopener noreferrer" className="text-base text-slate-400 hover:text-ucsb-gold">
                                    GitHub
                                </a>
                            </li>
                        </ul>
